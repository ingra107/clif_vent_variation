...
results_sex_category_height_ltvv <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 2: Sex Category + Height ~ Vt",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
...
results_sex_interaction_height_ltvv <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 3: Sex Category * Height ~ Vt",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
...
results_sex_interaction_height_ltvv_rcs <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 4: Sex Category * rcs(Height) ~ Vt",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
...
results_sex_category_bin <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 5: Sex Category ~ HTVV (Binary)",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
...
results_sex_category_height_bin <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 6: Sex Category + Height ~ HTVV (Binary)",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
...
results_sex_interaction_height_bin <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 7: Sex Category * Height ~ HTVV (Binary)",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
...
results_sex_interaction_height_rcs_bin <- model_results %>%
  ...
  mutate(
    ...
    Model = "Model 8: htvv ~ Sex Category * rcs(Height) ~ HTVV (Binary)",
    Site = site_name
  ) %>%
  # Rearrange columns
  dplyr::select(
