...
icu_hosp_ranks_8cc <- ltvv_variation |> 
  ...
  mutate(htvv = fcase(
    ...
    default = 0)) |> 
  group_by(hospital_id) |> 
  mutate(pct_over_8 = sum(htvv) / count_hosp) |> 
...
predictions_model11$Model <- "Model 1: Sex Category + LTVV" 
