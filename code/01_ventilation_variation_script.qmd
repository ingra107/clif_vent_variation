...
write.csv(mode_hospital_summary_table, paste0("output/final/mode_hospital_summary_table_",site_name,".csv"), row.names = FALSE)
...
### A FINAL TABLE
write.csv(mode_hourly_resp_support_table, paste0("output/final/mode_hourly_resp_support_table_",site_name, "_",Sys.Date(),".csv"), row.names = FALSE)
...
### A FINAL TABLE
write.csv(ltvv_variation_table, paste0("output/final/ltvv_variation_table_",site_name,"_", Sys.Date(),".csv"), row.names = FALSE)
```
...
### A FINAL TABLE
write.csv(ltvv_female_table, paste0("output/final/ltvv_female_table_",site_name,"_", Sys.Date(),".csv"), row.names = FALSE)
...
write.csv(results_to_save, paste0("output/final/sex_category_ltvv_", site_name, "_", Sys.Date(), ".csv"), row.names = FALSE)
